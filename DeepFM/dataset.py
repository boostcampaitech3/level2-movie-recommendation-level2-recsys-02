...
class RatingDataset(Dataset):
    def __init__(self, data_dir):
        data = pd.read_csv(data_dir + '/context-aware/ratings_with_genres.csv')
...
if __name__ == '__main__' :
    dataset = RatingDataset('/opt/ml/movie-recommendation/data/train/context-aware/ratings_with_genres.csv')
    print(len(dataset))